      ...
      <ol className="flex items-center gap-2">
        {steps.map((s, i) => (
          ...
          >
            <span
              className={cn(
                'ag-tabular flex size-8 shrink-0 items-center justify-center rounded-full text-caption font-semibold',
                i < current
            ...
            <span
              className={cn(
                'hidden text-caption md:inline',
                i === current ? 'font-semibold' : 'text-fg-secondary',
              )}
            >
              {s}
            </span>
