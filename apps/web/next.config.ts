...
const mapOrigin = new URL(process.env.NEXT_PUBLIC_MAP_STYLE_URL ?? 'https://basemaps.cartocdn.com/gl/positron-gl-style/style.json').origin;
...
const config: NextConfig = {
  ...
  experimental: { optimizePackageImports: ['lucide-react', '@agarha/ui-web', '@agarha/api-client'] },
