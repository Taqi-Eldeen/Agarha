...
const rubik = Rubik({ subsets: ['arabic', 'latin'], weight: ['500', '600'], variable: '--font-rubik', display: 'swap' });
...
export default async function LocaleLayout({ children, params }: { children: ReactNode; params: Promise<{ locale: string }> }) {
  ...
  return (
    <html lang={locale} dir={locale === 'ar' ? 'rtl' : 'ltr'} className={`${plexArabic.variable} ${plex.variable} ${rubik.variable}`} suppressHydrationWarning>
