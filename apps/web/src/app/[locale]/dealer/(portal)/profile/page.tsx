...
export default function Profile() {
  ...
  const form = useForm<ProfileForm>({
    ...
    resolver: schemaResolver(profileSchema, (v) => v, known),
  });
  useEffect(() => {
    ...
    if (d)
      form.reset({
        ...
        phone: d.phoneE164.replace('+20', '0'),
        whatsapp: d.whatsappE164.replace('+20', '0'),
      });
  }, [me.data, form]);
  ...
  return (
    <div className="flex max-w-2xl flex-col gap-4">
      ...
      {me.data ? (
        <Link
          href={`/dealers/${me.data.dealer.slug}`}
