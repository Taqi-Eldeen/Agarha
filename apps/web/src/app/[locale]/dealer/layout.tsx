...
export const metadata: Metadata = { robots: { index: false, follow: false }, manifest: '/manifest.webmanifest', appleWebApp: { capable: true, title: 'أجّرها', statusBarStyle: 'default' } };
