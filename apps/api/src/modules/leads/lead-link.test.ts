...
const base = {
  dealerWhatsapp: '+201012345678',
  dealerPhone: '+20223456789',
  carAr: 'تويوتا كورولا',
  carEn: 'Toyota Corolla',
  year: 2024,
  refCode: 'AG-7K2Q',
};
...
describe('lead links', () => {
  it('builds the Arabic WhatsApp message from the brief', () => {
    expect(leadMessage({ ...base, channel: 'whatsapp', locale: 'ar' })).toBe(
      'مرحباً، أستفسر عن تويوتا كورولا ٢٠٢٤ على أجّرها (Ref AG-7K2Q)',
    );
  });
